...
TRADER_DIR, TEMP_DIR = _get_trader_dir(".kttrader")
...
class ArrayManager(object):
    ...
    def __init__(self, size: int = 100):
        ...
        self.datetime_array: np.ndarray = np.zeros(size, dtype=object)
    ...
    def update_bar(self, bar: BarData) -> None:
        ...
        self.datetime_array[-1] = bar.datetime.strftime('%Y-%m-%d %H:%M:%S')
