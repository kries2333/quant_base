...
from app.cta_strategy.base import StopOrder
...
class CtaTemplate(ABC):
    ...
    def clear_candles(self):
        self.cta_engine.clear_candles()

    def put_candles(self, data):
        self.cta_engine.put_candles(data)

    def clear_indicators(self):
        self.cta_engine.clear_indicators()

    def put_indicators(self, data):
        self.cta_engine.put_indicators(data)
